...
require 'faker'
2.times do
  business = User.find(16).organisation
  charity = User.find(17).organisation
  message = Message.new(content: Faker::BackToTheFuture.quote)
  message.sender = business
  message.sender_type = business.class
  message.recipient = charity
  message.recipient_type = charity.class
  message.partnership_id = Partnership.first.id
  message.save!

  message1 = Message.new(content: Faker::BackToTheFuture.quote)
  message1.sender = charity
  message1.sender_type = charity.class
  message1.recipient = business
  message1.recipient_type = business.class
  message1.partnership_id = Partnership.first.id
  message1.save!
end
...
2.times do
  ...
  message.recipient = charity
  message.recipient_type = charity.class
  message.partnership_id = Partnership.last.id
  message.save!
  ...
  message1.recipient = business
  message1.recipient_type = business.class
  message1.partnership_id = Partnership.last.id
  message1.save!
end
